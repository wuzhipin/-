...
declare global {
    export namespace IEditor {
        ...
        export interface IUtils {
            ...
            readJson(filePath: string, silent?: boolean): any | null;
        ...
        export interface ITypeRegistry {
            ...
            addTypes(types: ReadonlyArray<FTypeDescriptor>): void;
        ...
        export interface IServiceProvider {
            ...
            handle(channel: string, func: Function, target?: any, passClientParam?: boolean): void;
        ...
        export namespace IAssetStoreTools {
            ...
            /**
            * 调用插件后台接口
            * @param action 目前内容固定为 call
            * @param resourceId 资源ID
            * @param billingMethod 计费方式 1-时长计费 2-计次计费
            * @param data 传递的数据
            */
