declare module BP {
    ...
    class BlueprintFactory {
         ...
         * @param varMap
         */
        static parseCls(name: string, isPlaying: boolean, newClass: any, data: IBPStageData, funs: IBPStageData[], varMap: Record<string, IBPVariable>, preload: string[]): void;
        static createClsNew<T>(name: string, isPlaying: boolean, cls: T, data: IBPStageData, funs: IBPStageData[], varMap: Record<string, IBPVariable>): T;
